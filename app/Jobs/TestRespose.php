...
class TestRespose implements ShouldQueue
{
    ...
    $data = $response->json();
    dd($data);
    // dd($this->order_id,$data['orderId'],$data['requestId'],$data['amount'],$data['transId'],$data['resultCode'],$data['message'],$data['requestType']);
    // $payment = new Payment();
    ...
    // $payment->resultCode = (int)$data['resultCode'];
